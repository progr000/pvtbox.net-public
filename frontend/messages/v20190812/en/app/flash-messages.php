...
return [
    ...
    'Confirm_email'                         => "Please confirm your email address to always get the latest updates from us and take advantage of all the benefits your account provides. <a href=\"#\" class=\"js-open-form\" data-src=\"#resend-confirm-modal\">Confirm e-mail</a>",
    'Confirm_email_plus_trial'              => "Please confirm your email address to always get the latest updates from us and take advantage of all the benefits your account provides. <a href=\"#\" class=\"js-open-form\" data-src=\"#resend-confirm-modal\">Confirm e-mail</a>",
    ...
    'ConfirmRegistrationAlreadyExist'       => "Email already confirmed",
    ...
    'Index_ChangeNameForm_success'          => "Company name was changed.",
    'Index_ChangeNameForm_error'            => "Change name failed.",
    'Index_ChangeOoAddressForm_success'     => "Online Office address was changed.",
    'Index_ChangeOoAddressForm__error'      => "Change Online Office address failed.",

    /* ---- */
    'flash_copied_ok'                                       => "Successfully copied to clipboard",
    'flash_share_sent_ok'                                   => "Share-link successfully sent to <b>{email}</b>.",
    'flash_guest_room_link_sent_ok'                         => "Guest link successfully sent to <b>{email}</b>.",
    ...
    'flash_conference_room_was_opened'                      => "Conference <b>{conference_name}</b> room opened. <a href=\"" . Url::to(['conferences/open-conference'], CREATE_ABSOLUTE_URL) . "?conference_id={conference_id}\">Join room</a>&nbsp;<a href=\"#\" class=\"void-0 close-alert\">Reject</a>",
    ...
    'license-restriction-businessUser-invite-non-registered' => "Please contact your administrator to invite new user",
    ...
    'pricing_feedback_success' => "Thank you for your enquiry. We'll contact you soon!",

    'SomeErrorOnJoinCollaborationWithThisEmail' => "",

    'more-then-one-business-admin-for-sh' => "
        <h1>System fault</h1>
        <br />
        There is more than one business-admin user in your database
        <br />
        this is not valid for this licensing system
    ",

    'contains-prohibited-types-license' => "
        <h1>System fault</h1>
        <br />
        Database contains a prohibited types of license
    ",

    'no-business-admin-user-in-db-for-sh' =>"
        <h1>System fault</h1>
        <br />
        No business-admin user presents in your database
    ",

    'Email_with_link_for_download_was_sent' => "Self-hosted installation instructions was sent to your email.",
    'Request_was_sent'  => "Request sent, support will contact you soon",

    'Participant_already_exist' => "Participant already exist in list",
];