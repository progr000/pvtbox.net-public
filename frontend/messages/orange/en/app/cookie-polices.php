...
<p>PB Private Cloud Solutions Ltd. ("us", "we", or "our") uses cookies on Pvtbox.net ("Website", or "Service"). By using the Service, you consent to the use of cookies</p>
...
<h2>Where to find more information about cookies?</h2>
