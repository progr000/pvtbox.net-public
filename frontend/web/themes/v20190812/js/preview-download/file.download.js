 ...
 */
function closeDownloadDiv(error)
{
    if (error) {
 ...
 * @param {string} status progress|finish|pause|cancel
 */
...
function recalcTotal()
{
    ...
    var total_speed = 0;
    var total_size = 0;
    $('#rows_downloads-rtc').find('.file-row').each(function() {
