...
if (elFinder && elFinder.prototype && typeof(elFinder.prototype.i18) == 'object') {
    ...
    //elFinder.prototype.i18.REPLACE_WITH_xx_OR_xx_YY_LANG_CODE = {
        ...
        messages   : {
            ...
            'cmddownload'			       : 'Download',
            'cmdshare'	   			       : 'Share',
            //'cmdunshare'                   : 'Cancel share',
            'cmdunshare'                   : 'Share',
            'cmdcollaborate'               : 'Collaborate',
            'cmdcolleaguelist'             : 'Colleague list',
            'cmdshowfileversions'          : 'File versions',
            'cmdshowfileversionsnotactive' : 'File versions',
            'cmdrestoredeletedfile'        : 'Restore file',
            'cmdopen_in_oo'                : 'Open in Online Office',
            'cmdglobalshare'               : 'Share',
            'cmdgetlink'                   : 'Get link',
            'cmdcollaborationsettings'     : 'Collaboration settings',
            ...
            'copyingInProgress' : 'Folder copying in progress.\\A Any action with it is restricted now.',
            'emptyFolder'     : 'Folder is empty', // from v2.1.6 added 30.12.2015
            'emptyFolderDrop' : 'Folder is empty\\A Drag & drop to add files', // from v2.1.6 added 30.12.2015
            ...
            'emptySearch'     : 'Nothing found', // from v2.1.12 added 5.16.2016
