...
if ( ! class_exists( 'Sirat_Content_Creation' ) ) :

	/**
	 * Sirat_Content_Creation class.
	 */
	class Sirat_Content_Creation extends WP_Customize_Control {
		...
		/**
		 * Sirat_Content_Creation constructor.
		 *
		...
		public function __construct( WP_Customize_Manager $manager, $id, array $args ) {
			$this->button_text;
			$manager->register_control_type( 'Sirat_Content_Creation' );
