...
function my_excerpt_length( $number ){
    // filter...
    return 1000;
}
...
function remove_css_from_wp_head() {
    ...
    wp_dequeue_style( 'sirat-font' );
    wp_dequeue_style( 'bootstrap' );
    wp_dequeue_style( 'font-awesome' );
    wp_dequeue_style( 'sirat-basic-style' );
    wp_dequeue_style( 'admin-bar' );
    wp_dequeue_style( 'nk-awb' );
    wp_dequeue_style( 'wp-block-library' );
    wp_dequeue_style( 'sirat-ie' );
}
...
function get_the_post_navigation_( $args = array() ) {
    $args = wp_parse_args(
        $args,
        array(
            'prev_text'          => '%title',
...
function getBackToMainBlock()
{
    return
    '<aside id="categories-main" class="widget widget_categories categories-main-page">
        <svg class="icon icon-back-arrow" style="display: inline;">
            <use xlink:href="#back-arrow"></use>
        </svg>
        <h4 class="widget-title"><a href="' . Url::to('/blog', CREATE_ABSOLUTE_URL) . '">Back to main</a></h4>
    </aside>';
}