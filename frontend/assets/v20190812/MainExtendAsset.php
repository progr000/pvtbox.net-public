...
class MainExtendAsset extends AssetBundle
{
     ...
     * и так же заменить пути для js и css (убрать из них часть пути themes/v20190812/)
    ...
    public $fullPathToMinimizedCss = '@frontend/web/assets/v20190812-min/css';
    public $webPathToMinimizedCss  = 'assets/v20190812-min/css/';
    public $fullPathToMinimizedJs  = '@frontend/web/assets/v20190812-min/js';
    public $webPathToMinimizedJs   = 'assets/v20190812-min/js/';
    public $pathToLinkMediaSources = '@frontend/web/assets/v20190812-min';
    public $mediaSourcesForLink = [
        ...
        '@frontend/web/themes/v20190812/videos',
        '@frontend/web/themes/v20190812/icons',
    ];
