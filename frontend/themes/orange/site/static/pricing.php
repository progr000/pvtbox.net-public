...
<div class="pricing">
    <div class="pricing__cont">
            ...
            <div class="pricing__box">
                <div class="pricing__box-cont">
                    ...
                    <div class="pricing__head">
                        ...
                        <!--<span class="pricing__head-price">$ <span style="font-weight: 600;" id="price-professional"><?= $sum_professional ?></span></span>-->
                        <span class="pricing__head-price">$ <span style="font-weight: 600;" id="price-professional-one-time"><?= $sum_professional_one_time ?></span></span>
                        ...
                        <span class="pricing__head-time pricing__head-one-time"><?= Yii::t('app/pricing', 'head_time_PRO_one_time') ?></span>
                            ...
                            Yii::$app->user->isGuest
                                ...
                                : (
                                    ...
                                    (in_array($User->license_type, [/*Licenses::TYPE_PAYED_BUSINESS_ADMIN,*/ Licenses::TYPE_PAYED_BUSINESS_USER]) || in_array($User->payment_already_initialized, [Users::PAYMENT_INITIALIZED, Users::PAYMENT_PROCESSED]))
                                        ...
                                        : '<a class="btn-default" id="link-professional-one-time" href="' . Url::to(['/purchase/summary?license=professional&billed=onetime'], CREATE_ABSOLUTE_URL) .'">' . Yii::t('app/pricing', 'Purchase_now') . '</a>'
                                )
                            ?>
                        </div>
        ...
        <div class="means-guard">
            <img src="/themes/orange/images/guard-102x118.png" alt="Electronic Vault" />
            <div class="means-guard-link">
                <a href="https://pvtbox-evault.com/" target="_blank">"Electronic Vault" - ready to use service from Pvtbox.</a>
            </div>
            <div class="means-guard-info">
                *The service aimed for protected data storage and transfer on user trusted devices only.
            </div>
        </div>
        ...
        <ul class="list-carts awards">
            <li><img src="/themes/orange/images/comodo_secure_100x85.png" alt="" /></li>
            <li><img src="/themes/orange/images/award2.jpg" alt="" /></li>
            <li><img src="/themes/orange/images/award3.jpg" alt="" /></li>
        </ul>

        <div class="carts"><p>We guarantee 100% satisfaction with our services.<br>Otherwise, our office support solve all of your questions.</p></div>
