...
<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top" style="text-align: center;">
    <!--<h3>Professional monthly pay form:</h3>-->
    <input type="hidden" name="cmd" value="_s-xclick">
    <input type="hidden" name="hosted_button_id" value="EURXFAGLDSMVA">
    <input type="hidden" name="item_name" value="<?= $User->user_id ?>" />
    <div class="pp-total-info" style="">
        <span class="pp-span-total-info"><?= Yii::t('app/purchase', 'Total') ?>: $<span class="pp-total-sum-val"><?= number_format(Preferences::getValueByKey('PricePerMonthForLicenseProfessional', 99.99, 'float'), 2, '.', '') ?></span></span>
    </div>
