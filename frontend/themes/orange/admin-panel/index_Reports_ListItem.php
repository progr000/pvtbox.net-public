...
<div class="table__body">
    ...
    <div class="table__body-box"><div class="userId color-<?= $icon['color'] ?>"><strong><?= $icon['sname'] ?></strong></div><b><?= $model->colleague_user_email ?></b></div>
    <div class="table__body-box"><?= $TEMPLATES[$event_type] ?></div>
    <!--<div class="table__body-box"><b class="table-color-green">Signed in</b><b class="table-color-darkBlue">/Current</b></div>-->
    <div class="table__body-box"><span <span class="<?= ($model->report_isnew ? 'isnew' : 'table-color-gray' ) ?>"><?= date(Yii::$app->params['datetime_format'], $model->_report_date_ts) ?></span></div>
</div>
