...
<div class="steps-item__choice">
    ...
    <div class="form-row-flex">
        <div class="select-wrap">
            <select class="js-select" name="os0" id="pba-os0" aria-required="true" aria-invalid="false">
        ...
        <div class="select-wrap">
            <select class="js-select" name="server_license_count" id="server-license-count-annually" aria-required="true" aria-invalid="false">
