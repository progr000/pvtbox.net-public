        ...
        <div class="collaborate-modal-body">
            ...
            <table style="display: none;">
                ...
                <tr class="table__body {owner_or_colleague}" id="collaborate-user-{colleague_id}">
                    ...
                    <td>{email}</td>
                    <td>
                        <b class="table-status">{status}</b>
                        <svg class="{button_resend} icon icon-resend-invite resend-invite masterTooltip" title="Resend Invite"
                             data-tokens="{colleague_id}"
                             data-alert-type="snack">
                            <use xlink:href="/themes/v20190812/images/email-sync-outline.svg#letter"></use>
                        </svg>
                        <i>{date}</i>
                    </td>
                    <td>
