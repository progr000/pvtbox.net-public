...
?>
<!-- begin .page-footer-->
<footer class="page-footer page-footer--admin delta-height-div">
    <div class="container">
        <div class="row">
                ...
                <ul class="secondary-menu js-sec-menu-2"><!-- эти коменты - костыли https://stackoverflow.com/questions/5078239/how-do-i-remove-the-space-between-inline-block-elements
                    ...
                    --><li class="secondary-menu__item"><?=
                        (Yii::$app->controller->id == 'blog' || $static_action == 'blog')
                            ? '<span>' . Yii::t('app/header', 'Blog') . '</span>'
                            : '<a href="' . Url::to('/blog', CREATE_ABSOLUTE_URL) . '">' . Yii::t('app/header', 'Blog') . '</a>'
                        ?></li><!--
