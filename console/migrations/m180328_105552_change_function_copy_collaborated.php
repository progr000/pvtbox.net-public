...
/**
 * Class m180328_105552_change_function_copy_collaborated
 */
class m180328_105552_change_function_copy_collaborated extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        ...
        Yii::$app->db->pdo->exec("
            ...
            ALTER TYPE record_copy ADD ATTRIBUTE event_creator_user_id bigint;
            ALTER TYPE record_copy ADD ATTRIBUTE event_creator_node_id bigint;
            ...
            AS \$BODY\$
                ...
                begin
                    ...
                    loop
                        ...
                        _rec.parent_before_event = _event.parent_before_event;
                        _rec.parent_after_event = _event.parent_after_event;
    ...
    {
        echo "m180328_105552_change_function_copy_collaborated cannot be reverted.\n";
