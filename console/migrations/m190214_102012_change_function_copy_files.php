...
/**
 * Class m190214_102012_change_function_copy_files
 */
class m190214_102012_change_function_copy_files extends Migration
{
    /**
     * {@inheritdoc}
     */
                ...
                begin
                    ...
                    for _file in SELECT * FROM (
                        ...
                        UNION ALL
                            SELECT * FROM (
                                ...
                                AND e2.event_id = (SELECT max(event_id) FROM {$tablePrefix}user_file_events WHERE file_id = e2.file_id AND event_timestamp < max_timestamp)  --added 05.09.2018
                                --AND f2.user_id = ff.user_id
                    ...
                    loop
                        ...
                        */
                        ...
                        _rec.event_creator_user_id = _file.event_creator_user_id;
                        _rec.event_creator_node_id = _file.event_creator_node_id;

                        _rec.event_group_timestamp = _event_group_timestamp;
                        _rec.event_group_id = _event_group_id;
                        ...
                        if _rec.is_folder = 1 then
                            ...
                            _rec.file_size_before_event = 0; --@@-- event
                        ...
                        if (_is_debug = false) then
                            ...
                            INSERT INTO {$tablePrefix}user_files
                                ...
                                is_outdated, last_event_type, last_event_uuid, diff_file_uuid,
                            ...
                            VALUES
                                ...
                                _rec.is_outdated, _rec.last_event_type, _rec.event_uuid, _rec.diff_file_uuid,
                            ...
                            VALUES
                                ...
                                _rec.event_group_timestamp, _rec.event_group_id);
    ...
    {
        echo "m190214_102012_change_function_copy_files cannot be reverted.\n";
