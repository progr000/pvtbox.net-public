...
/**
 * Class m190214_103342_change_function_copy_collaboration_to_user
 */
class m190214_103342_change_function_copy_collaboration_to_user extends Migration
{
    /**
     * {@inheritdoc}
     */
                ...
                */
                ...
                begin
                    ...
                    select f.*
                        ...
                        and f.is_deleted = 0
                        and c.collaboration_status IN (1, 2)  --active or locked
                    ...
                    loop
						...
						if _rec.file_parent_id = 0 then  -- root folder
							_rec.file_name_after_event = _source.file_name;
                        else
    ...
    {
        echo "m190214_103342_change_function_copy_collaboration_to_user cannot be reverted.\n";
