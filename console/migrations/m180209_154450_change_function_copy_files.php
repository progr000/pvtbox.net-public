...
/**
 * Class m180209_154450_change_function_copy_files
 */
class m180209_154450_change_function_copy_files extends Migration
{
    /**
     * @inheritdoc
     */
    public function safeUp()
    {
        ...
        Yii::$app->db->pdo->exec("
            ...
            DROP FUNCTION IF EXISTS copy_files(bigint, bigint, character varying, character varying, bigint);
            ...
            ALTER FUNCTION copy_files(bigint, bigint, character varying, character varying, bigint, boolean)
                OWNER TO {$userName};
        ");
    }
    ...
    {
        echo "m180209_154450_change_function_copy_files cannot be reverted.\n";
